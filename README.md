...
- `GET /api/anime`: llista animes amb paginació opcional i filtres de gènere, estado i valoració (`genre`, `status`, `minRating`, `maxRating`). Els valors per a `status` són: `"Currently Airing"`, `"Finished Airing"`, `"Not yet aired"`.
