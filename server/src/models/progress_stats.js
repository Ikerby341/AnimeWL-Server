export function sumChapterMinutes(chapterRows = [], chaptersWatched = 0) {
...
export function calculateTotalMinutes(progressRows = []) {
...
export function calculateTotalChapters(progressRows = []) {
    return (progressRows || []).reduce(
...
export function countFinishedAnimes(progressRows = [], episodeCounts = {}) {
